...
//    public void cyclecore(int source,char[]state){
//        if(state[source]=='U'){
//            state[source]='V';
//            List<Integer> neighbours=gr.get(source);
//            for (int neighbour:neighbours){
//                cyclecore(neighbour,state);
//            }
//            state[source]='P';
//        } else if (state[source]=='V') {
//            System.out.println("Cycle not Found! at node "+source);
//        }
//    }
//    public void detectCycle(){
//        char[]state=new char[gr.size()];
//        Arrays.fill(state,'U');
